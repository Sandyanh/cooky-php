...
<body>
    <?php
        ob_start();
        include 'connect.php';
        $sql = "SELECT `cat_id`, `tendanhmuc`, `hinhanh`, `ngaytao`, `ngaycapnhat` FROM `category`";
    ...
    <div class="wrapper">
        ...
        <div class="p-4">
            ...
            <div class="btn-add mb-3">
                <a class="text-light text-decoration-none btn btn-primary btn-sm" href="./addcategory.php">
                ...
                <table class="table">
                    ...
                    ?>
                            <tr class="text-center">
                                ...
                                <td class="text-primary"><?php echo $item['tendanhmuc'];?></td>
                                <td><img class="border rounded" src="./uploads/<?php echo $item['hinhanh'];?>" alt="" width="100" height="100"></td>
                                <td><?php echo $item['ngaytao'];?></td>
                                <td><?php echo $item['ngaycapnhat'];?></td>
                                <td>
                                    <a href="deletecategory.php?id=<?php echo $item['cat_id'];?>" title="Xóa" class="btn btn-outline-danger btn-sm border border-0 delete-category-button" data-category-id=""><i class="fa-regular fa-trash-can"></i></a>
                                    <a href="editcategory.php?id=<?php echo $item['cat_id'];?>" title="Sửa" class="btn btn-outline-info btn-sm border border-0"><i class="fa-regular fa-pen-to-square"></i></a>
                                </td>
                            </tr>
                    <?php
                    }
